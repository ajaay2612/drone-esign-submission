...
{#if showSigningSuccess}
    ...
    xl:top-[5.6em] xl:text-[1.3em]">
        ...
        <p class="md:whitespace-nowrap">Document has been sent and is awaiting approval</p>
    </div>
{/if}
...
>
    ...
    md:text-[1.2em] lg:text-[1em] 2xl:text-[1.15em] lg:mt-1hem">
        ...
        {#each data.envelopeStatuses.slice(-1) as statuses}
            <DocumentBlock agreementId={statuses.agreementId} docData={statuses.agreementData}/>  
        {/each}
