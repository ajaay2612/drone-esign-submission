...
<script>
    ...
    let newUserName = newOwner.firstName+" "+newOwner.lastName;
    let newUserAddress = newOwner.streetAddress+", "+newOwner.city+", "+newOwner.state+", "+newOwner.zipCode;
    let newUserContact = newOwner.email+", "+newOwner.countryCode +" "+newOwner.phoneNumber;
...
<section class="drone-registration-container">
    <div class="registration-header">
        ...
        <h1 class="registration-title">Drone Transfer Agreement</h1>
    ...
    {#if page == 0 }
        <div class="registration-content">
            <div class="registrant-details">
                <p>This Drone Ownership Transfer Agreement (the "Agreement") is made and entered into as of the date of execution, by and between:</p>
    
                <div class="ownerHeadCont">
                    <p class="ownerHead"><span style="padding-right:5px;">A.</span> <span> Original Owner</span></p>
                ...
                <div class="ownerHeadCont">
                    <p class="ownerHead"><span style="padding-right:5px;">B.</span> <span> New Owner</span></p>
                    <div class="registrant-details-innerCont">
                        <p><span style="padding-right:5px;">Registrant Name:</span> {newUserName}</p>
                        <p><span style="padding-right:5px;" >Address:</span> {newUserAddress}</p>
                        <p><span style="padding-right:5px;" >Contact Information:</span> {newUserContact}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="reg-fields">
                ...
                <p>The purpose of this Agreement is to formalize the transfer of drone ownership, ensuring legal compliance, proper registration updates, and protection of all parties' interests. This document serves as a comprehensive legal instrument that outlines the responsibilities, rights, and obligations of the Original Owner, New Owner, and Dronova during the ownership transfer process.</p>
            </div>
    ...
    {#if page == 1 }
        <div class="registration-content">
            ...
            <div class="reg-fields">
                <h2><span  style="padding-right:5px;">3.</span> Drone Images</h2>
    ...
    {#if page == 2 }
        <div class="registration-content">
            ...
            <div class="reg-fields">
                <h2><span  style="padding-right:5px;">5.</span>  Warranties and Representations</h2>
                <p>The Original Owner provides explicit warranties regarding the drone's ownership and condition. They affirm legal ownership, confirm the drone's represented condition at the time of transfer, and commit to providing all previous maintenance and operational records to the New Owner.</p>

                <p>The New Owner acknowledges full understanding of the drone's condition and accepts all associated responsibilities and regulatory requirements. This mutual understanding ensures transparency and prevents future disputes about the drone's state at the time of transfer.</p>
            </div>
            
            <div class="reg-fields">
                <h2><span  style="padding-right:5px;">6.</span>  Liability and Indemnification</h2>
                <div class="registrant-details-innerCont">
                    <p>
                        From the date of transfer, the New Owner assumes complete liability for the drone. The Original Owner is legally released from all future liability following the successful completion of the transfer. Dronova is explicitly held harmless from any potential disputes arising from the ownership transfer.                    
                    </p>
                </div>
            </div>
    ...
    {#if page == 3 }
        <div class="registration-content">
            ...
            <div class="signerStage">
                <div class="">
                    <p><span style="padding-right:5px;">Original Owner Signature:</span> <span style="color: white;" class="signField">signer1sig</span></p>
                    <p><span style="padding-right:5px;">Date:</span> <span style="color: white;" class="signField">signer1date</span></p>
                </div>
                <div class="">
                    <p><span style="padding-right:5px;">New Owner Signature:</span> <span style="color: white;" class="signField">signer3sig</span></p>
                    <p><span style="padding-right:5px;">Date:</span> <span style="color: white;" class="signField">signer3date</span></p>
                </div>
                <div class="">
...
<style>
    ...
    /* .drone-registration-container {
        @apply font-inter text-[0.86rem] leading-[1.5em] py-[2em] px-[3.4em] mx-auto ;
    } */
    ...
    .ownerHead{
        @apply text-black font-plus-jakara font-medium;
    }
</style>